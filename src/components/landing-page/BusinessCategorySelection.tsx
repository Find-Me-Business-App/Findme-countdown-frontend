...
export default function BusinessCategorySelection({ onSelect, onBack }: BusinessCategorySelectionProps) {
    ...
    return (
        <div className="flex flex-col w-full max-w-2xl mx-auto">
            ...
            {onBack && (
                <button
                    onClick={onBack}
                    className="mt-8 text-sm font-medium hover:underline self-start"
                    style={{ color: THEME.colors.text.muted }}
                >
                    Back
                </button>
