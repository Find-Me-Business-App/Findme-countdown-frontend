                    ...
                    >
                        {SOCIALS.map(({ Icon, href }, idx) => (
                            <Link
                                key={idx}
                                href={href}
                                className="w-10 h-10 md:w-11 md:h-11 rounded-full border border-[#1d294d]/20 flex items-center justify-center hover:bg-[#1d294d] hover:text-white transition-all duration-300 group"
                            >
                                <Icon className="w-4 h-4 md:w-5 md:h-5 text-[#1d294d] group-hover:text-white stroke-[1.5px] transition-colors" />
                            </Link>
                        ))}
                    </motion.div>
                </motion.div>
