...
export default function ContactModal() {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <ModalContainer 
                type="registration"
                className="px-4 pb-4 pt-12 md:p-5 w-full md:w-[777px] min-h-[400px] md:h-[444px] md:min-h-[444px] flex flex-col justify-center"
                maxWidth="max-w-[420px] md:max-w-[777px]"
            >
                <ModalCloseButton 
                    onClick={closeModal} 
                    className="flex h-9 w-9 items-center justify-center rounded-full border border-white/20 bg-black/30 hover:border-white/40 backdrop-blur-sm top-1.5 right-1.5 md:top-5 md:right-5 z-50 !absolute"
                />
