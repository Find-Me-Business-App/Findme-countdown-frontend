...
export const INFO_CONFIGS: Record<SectionType, InfoSectionConfig> = {
    home: {
        title: "About FindMe",
        description: [
            "FindMe is a unified digital ecosystem connecting individuals and businesses through AI-powered systems. Operating as a scalable SaaS solution, it simplifies service discovery, financial organization, and multi-enterprise synchronization within one interface.",
            "Beyond digital tools, FindMe deploys trained physical agents for localized support, ensuring neighborhood enterprises thrive.",
            "From procurement to recycling, the platform manages the entire business lifecycle while promoting global sustainability standards to ensure no one is left behind in the digital age."
        ],
    ...
    business: {
        ...
        description: [
            "FindMe App Business is the easiest way to run a business. As a business owner today, there are on-ground issues which are a hassle to manage all functions of the business, from recruitment, to company setup and  administration management. That is why it is said that running business is for the tough.",
            "Forget online productivity tools, there are in-house business systems and daily business pain-points that businesses experience. Lets come back online, in today's world, do you know how much businesses spend on various platform subscriptions? FindMe provides the framework for the application of all these functions seamlessly in one system.",
            "FindMe is a seamless all-in-one enterprise solution providing AI tools for business management, operations, financial organizations, research enhancement and custom design. By integrating tailored AI models and multi business synchronization, it streamlines complex operations within your business infrastructure tailored by global standards.",
    ...
    festival: {
        ...
        description: [
            ...
            "The festival is built on three pillars: connection, fun, and growth. Merchants and creatives will showcase their products and services to a vibrant audience, while Africa’s spirit and energy take center stage - raw, authentic, and unforgettable.",
            "We’ll unveil what FindMe stands for, how it works, the benefits it offers, and the opportunities ahead including how individuals can use AI to improve input, amplify output, and unlock new levels of personal and business growth.",
            "This is an invitation. To connect, To build, To celebrate, To be part of something from the very beginning. Cross borders and distance, we stretch out our hands in friendship, come and make this festival unforgettable. Attend, Participate, Experience.",
            "FindMe Festival isn’t just an event. It’s a moment you don’t want to miss. Festival Artisans and Businesses that are to participate in the festival can rent their stands in the setup from the Participate button. Welcome once again to the world of FindMe as we celebrate in vibrant sounds and colours. Participate >>>>"
        ],
        subDescription: "Create, manage and automate all astacking.",
